...
<header class="header">
    ...
    <a href="#" class="logo"> <i class="fas fa-heartbeat"></i> <strong>E</strong>medical </a>
...
<section class="review" id="review">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <p class="text">It was great service.
                I am very satisfied by your facility.
                Convenient and easy to use website
Fast and reliable delivery
Competitive pricing
Wide selection of medications available
...
Good customer service
Secure and private
Accurate and on-time delivery</p>
        </div>
...
<section class="footer">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a href="#"> <i class="fas fa-phone"></i> +9848045578 </a>
            <a href="#"> <i class="fas fa-phone"></i> +9848045578 </a>
            <a href="#"> <i class="fas fa-envelope"></i> epharma@gmail.com </a>
            <a href="#"> <i class="fas fa-envelope"></i> epharma@gmail.com </a>
            <a href="#"> <i class="fas fa-map-marker-alt"></i>Dillibazar, Kathmandu </a>
        </div>
    ...
    <div class="credit"> created by <span>Aaruhi Sen</span> | all rights reserved </div>
